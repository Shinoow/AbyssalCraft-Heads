 ...
 */
public class ModelChagarothFistHand extends ModelBase {
	...
	public ModelChagarothFistHand() {
		textureWidth = 64;
		textureHeight = 32;
		finger2 = new ModelRenderer(this, 8, 0);
		finger2.setRotationPoint(-1.5F, 22.5F, 1.0F);
		...
		finger33.setRotationPoint(0.0F, 18.0F, 2.0F);
		...
		finger43.setRotationPoint(1.5F, 18.0F, 2.0F);
		...
		finger42.setRotationPoint(1.5F, 20.5F, 2.0F);
		...
		finger22.setRotationPoint(-1.5F, 20.5F, 2.0F);
		finger22.addBox(0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F);
		finger5 = new ModelRenderer(this, 8, 0);
		finger5.setRotationPoint(2.0F, 22.5F, 0.0F);
		...
		finger13.setRotationPoint(-3.0F, 18.0F, 2.0F);
		...
		finger4.setRotationPoint(1.5F, 22.5F, 1.0F);
		...
		finger12.setRotationPoint(-3.0F, 20.5F, 2.0F);
		finger12.addBox(0.0F, -3.0F, 0.0F, 1, 3, 1, 0.0F);
		finger1 = new ModelRenderer(this, 8, 0);
		finger1.setRotationPoint(-3.0F, 22.5F, 1.0F);
		...
		finger23.setRotationPoint(-1.5F, 18.0F, 2.0F);
		...
		finger53.setRotationPoint(3.0F, 18.0F, 0.0F);
